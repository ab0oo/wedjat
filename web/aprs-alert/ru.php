...
function addrule(pndx, allowEdit) {
    ...
    if (true) {
        cell.innerHTML =
            "<A href='#' onclick=\"remove_onclick(" + nRow + ",'" + rule_id + "',this);return false;\" title='Remove rule from rule list'><IMG border='0' src='remove.png'></A>" +
            (isNew ? "":"&nbsp;<A href='#' onclick=\"edit_onclick(" + nRow + ",'" + rule_id + "',this);return false;\" title='Edit this rule'><IMG border='0' src='edit.png'></A>") +
            (isNew ? "":"&nbsp;<A href='#' onclick=\"undo_onclick(" + nRow + ",'" + rule_id + "',this);return false;\" title='Undo changes or undelete this rule'><IMG border='0' src='undo.png'></A>");
    }
